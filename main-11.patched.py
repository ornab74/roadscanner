...
def create_tables():
    ...
    with sqlite3.connect(DB_FILE) as db:
        ...
        users_alter_map = {
            "google_sub": "ALTER TABLE users ADD COLUMN google_sub TEXT UNIQUE",
...
<body>
    ...
    <div class="container">
        <div class="walkd shadow">
            ...
            {% if google_auth_available %}
            <a class="btn btn-light btn-block mt-3" href="{{ url_for('google_start') }}">Register / Login with Google</a>
            {% endif %}
